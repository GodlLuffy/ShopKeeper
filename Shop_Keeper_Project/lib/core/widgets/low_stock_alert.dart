                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.notification_important_rounded, color: AppColors.warningAmber, size: 18),
                      ),
                      const SizedBox(width: 12),
                      const Expanded(
                        child: Text('STOCK ALERTS', style: TextStyle(
                          fontSize: 12, fontWeight: FontWeight.w900, color: AppColors.warningAmber, letterSpacing: 1.5,
                        )),
                      ),
                      TextButton(
                        onPressed: () => context.push('/inventory'),
                        child: const Text('VIEW ALL', style: TextStyle(color: AppColors.accentTeal, fontWeight: FontWeight.w700, fontSize: 11)),
                      ),
                    ],
                  ),
