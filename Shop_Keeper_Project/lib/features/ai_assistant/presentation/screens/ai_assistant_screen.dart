  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.cleaning_services_rounded, color: AppTheme.dangerRose),
        ...
        child: Column(
          children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.auto_awesome_rounded, size: 64, color: AppTheme.primaryIndigo),
                            ),
                            const SizedBox(height: 24),
                            const Text(
                              "UNITS ONLINE • READY TO ASSIST", 
                              style: TextStyle(color: AppTheme.textWhite, fontWeight: FontWeight.w900, fontSize: 12, letterSpacing: 1.5),
                            ),
                          ...
                          child: Container(
                            ...
                            child: GlassCard(
                              ...
                              child: Text(
                                message['content'] ?? '',
                                style: TextStyle(
                                  color: isUser ? AppTheme.accentTeal : AppTheme.textWhite,
                                  fontSize: 14,
                                  height: 1.5,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w900, color: AppTheme.accentTeal.withOpacity(0.7), fontSize: 10, letterSpacing: 1),
                    ),
                  ],
                ),
              ).animate().fadeIn(),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: AppTheme.darkBackgroundLayer.withOpacity(0.9),
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: const TextStyle(color: AppTheme.textMuted, fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 1),
                            filled: true,
                            fillColor: AppTheme.darkBackgroundMain.withOpacity(0.5),
                            ...
                            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(30), borderSide: BorderSide(color: AppTheme.primaryIndigo.withOpacity(0.5), width: 1.5)),
                          ),
                          onSubmitted: (val) {
                            if (val.isNotEmpty) {
