...
String _mapFirebaseAuthError(FirebaseAuthException e) {
  ...
  switch (code) {
    ...
    case 'invalid-credential':
      return 'Invalid credentials. Check email/password and ensure Email/Password sign-in is enabled in Firebase Console.';
    case 'invalid-api-key':
      return 'Firebase API key is invalid. Check your google-services.json configuration.';
    case 'app-not-authorized':
      return 'App is not authorized. Check API key restrictions in Google Cloud Console.';
    case 'operation-not-allowed':
      return 'Email/Password sign-in is not enabled. Go to Firebase Console > Authentication > Sign-in method.';
    case 'network-error':
      return 'Network error. Check your internet connection.';
    case 'too-many-requests':
      return 'Too many attempts. Please try again later.';
    case 'internal-error':
      return 'Internal error. This may be due to API key restrictions on Windows. Check Google Cloud Console > Credentials.';
    default:
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, void>> sendPasswordResetEmail(String email, {ActionCodeSettings? actionCodeSettings}) async {
    try {
      await remoteDataSource.sendPasswordResetEmail(email, actionCodeSettings: actionCodeSettings);
      return const Right(null);
    } on FirebaseAuthException catch (e) {
      return Left(AuthFailure(_mapFirebaseAuthError(e)));
    } catch (e) {
