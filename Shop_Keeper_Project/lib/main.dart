...
void main() async {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'SYSTEM EXCEPTION',
                  style: TextStyle(fontWeight: FontWeight.w900, color: AppColors.textPrimary, letterSpacing: 2, fontSize: 12),
                ),
  ...
  try {
    ...
    // Initialize Notifications if Firebase is active and platform supports it
    if (firebaseInitialized && !Platform.isWindows && !Platform.isLinux && !Platform.isMacOS) {
      await di.sl<NotificationService>().initialize();
      debugPrint('NOTIFICATIONS: Initialized successfully');
    } else if (firebaseInitialized) {
      debugPrint('NOTIFICATIONS: Skipping initialization on desktop platform');
    }
